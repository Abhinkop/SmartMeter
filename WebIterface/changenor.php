	 ...
	 -->
        ...
        <div class="container">
			...
			<section class="af-wrapper">
	            <h3>Enter the following details to Change Number of Rooms</h3>
		        
				
				<form class="af-form" method="post" action="updatenor.php" id="af-form">     <!--      form values submited  hereeeeeeeeeeeeeeeeeeeeeeeeeeeeee -->
					...
					<input type="submit" value="Change Number of Rooms !" onclick="return(validateForm());" /> 
