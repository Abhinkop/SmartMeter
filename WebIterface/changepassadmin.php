		  ...
		  if( document.forms["af-form"]["password"].value == "" )
   {
    ...
    <body>
        ...
        <div class="container">
			...
			<header>
				<span></span>
				<h1>Change Administrator Password<span>!</span></h1>
			...
			<section class="af-wrapper">
				...
				<form class="af-form" method="post" action="updateadminpassword.php" id="af-form">     <!--      form values submited  hereeeeeeeeeeeeeeeeeeeeeeeeeeeeee -->
				
					<div class="af-outer ">
						<div class="af-inner">
						  <label for="input-country">Enter New Password</label>
						  <input type="password" name="password" id="password" required>
						</div>
					</div>
					
					<input type="submit" value="Change Password !" onclick="return(validateForm());" /> 
